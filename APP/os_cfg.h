...
#define OS_EVENT_NAME_SIZE        40    /* Determine the size of the name of a Sem, Mutex, Mbox or Q    */
...
#define OS_TICKS_PER_SEC       1000    /* Set the number of ticks in one second                        */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    48    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   48    /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   48    /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_FLAGS_NBITS            0    /*     Size in #bits of OS_FLAGS data type (8, 16 or 32)        */
